...
const ICONS: Record<string, string> = {
  ...
  ruler: '<path d="M3 17L17 3l4 4L7 21z"/><path d="M6.5 13.5l2 2M9.5 10.5l2 2M12.5 7.5l2 2"/>',
  cut: '<rect x="5" y="4" width="14" height="16" rx="2"/><path d="M2 12h20" stroke-dasharray="3 2"/>',
  steps: '<path d="M3 20h5v-5h5v-5h5V5h3"/><circle cx="6" cy="11" r="1.4" fill="currentColor"/>',
  gauge: '<path d="M4 18a8 8 0 1116 0"/><path d="M12 18l4-5"/><path d="M6 18h.01M18 18h.01" stroke-width="2.4"/>',
  fit: '<path d="M4 9V4h5M20 9V4h-5M4 15v5h5M20 15v5h-5"/>',
  display: '<path d="M4 7h10M18 7h2M4 17h2M10 17h10"/><circle cx="16" cy="7" r="2"/><circle cx="8" cy="17" r="2"/>',
