...
- **Prateleiras (trilhos):** três aberturas conforme o nível de material e a carga da gaveta que apoiam: trilhos (mínimo), moldura com travessas (equilibrado) ou fechada (reforçado ou carga pesada).
